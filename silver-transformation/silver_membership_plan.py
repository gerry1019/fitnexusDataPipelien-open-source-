...
BRONZE_PATH = f"s3a://{bucket}/bronze/MembershipPlan"
SILVER_PATH = f"s3a://{bucket}/silver/membership_plan"
CHECKPOINT_PATH = f"s3a://{bucket}/silver/membership_plan/_checkpoint"

spark = create_spark_session("Silver MembershipPlan")

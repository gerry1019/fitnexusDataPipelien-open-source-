...
BRONZE_PATH = f"s3a://{bucket}/bronze/Booking"
SILVER_PATH = f"s3a://{bucket}/silver/booking"
CHECKPOINT_PATH = f"s3a://{bucket}/silver/booking/_checkpoint"

spark = create_spark_session("Silver Booking")

...
BRONZE_PATH = f"s3a://{bucket}/bronze/Staff"
SILVER_PATH = f"s3a://{bucket}/silver/staff"
CHECKPOINT_PATH = f"s3a://{bucket}/silver/staff/_checkpoint"

spark = create_spark_session("Silver Staff")
...
df_clean = (
    ...
    .withColumn("specialty", upper(trim(col("specialty"))))

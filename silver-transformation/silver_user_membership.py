...
BRONZE_PATH = f"s3a://{bucket}/bronze/UserMembership"
SILVER_PATH = f"s3a://{bucket}/silver/user_membership"
CHECKPOINT_PATH = f"s3a://{bucket}/silver/user_membership/_checkpoint"

spark = create_spark_session("Silver UserMembership")
